...
export default function SkillFilter({ setOpen, selectedFilter, handleFilter }: SkillFilterProps) {
    ...
    return (
        <div ref={cardRef} className="bg-[#181818] border border-gray-700 rounded shadow-md shadow-blue-300/10 p-5 w-screen max-w-[500px] absolute top-[10px] left-0">
            ...
            <p className="text-base text-gray-400 font-light">Keep it organized! You can filter the skills by their type. </p>
                ...
                {Object.values(SkillType).map((skill: string, index: number) => (
                    <div
                        ...
                        className={classNames('border border-gray-600 bg-transparent hover:bg-gray-600/60 duration-200 cursor-pointer rounded p-2 flex flex-row items-center gap-4', {
                            'border-blue-400 bg-gray-600/20': selectedFilter === skill,
                        })}
                    >
